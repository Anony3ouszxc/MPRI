...
class Image {
     ...
     *
     *
     * @param unknown $key   name of the property
     ...
     *
     *
     * @param unknown $type type of the image
     * @param unknown $src  image source
    ...
    public function changeDimensions(
        ...
        $imgAllocate =imagecolorallocate($thumbImg, 0, 0, 0);
        imagefill($thumbImg, 0, 0, $imgAllocate);
        $this->setTransparency( $thumbImg, $sourceImage );
