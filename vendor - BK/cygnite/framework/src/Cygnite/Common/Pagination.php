...
class Pagination
{
    ...
    public function createLinks($total="")
    {
        if( $total >= 0 ){
    ...
    private function createCurrentActiveLink($pageNumber, $counter, $content = '')
    {
        if ($counter == $pageNumber) {
            $content.= "<li class=\"footable-page active\"><a class=\"current\">$counter</a></li>";
        } else {
            $content.= "<li class=\"footable-page\"><a href='".$this->currentPageUrl."/".$counter."'>$counter</a></li>";
        }
    ...
    {
        $content = '';
        $content.= "<li class=\"footable-page\"><a href='".$this->currentPageUrl."/1'>1</a></li>";
        $content.= "<li class=\"footable-page\"><a href='".$this->currentPageUrl."/2'>2</a></li>";
    ...
    private function createSecondLink()
    {
        $content = '';
        $content.=
            "<li class=\"footable-page\"><a href='".$this->currentPageUrl."/".$this->lastPageMinusOne."'>$this->lastPageMinusOne</a></li>";
        $content.=
            "<li class=\"footable-page\"><a href='".$this->currentPageUrl."/".$this->lastPage."'>$this->lastPage</a></li>";
    ...
    public function renderPreviousLink($pageNumber, $content = '')
    {
        ...
        if ($pageNumber > 1) {
            $content.= "<li><a href='".$this->currentPageUrl."/".$this->previous."'> «</a></li>";
        } else {
            $content.= "<li><a class=\"disabled\"> «</a></li>";
        }
    ...
    public function renderNextLink($counter, $pageNumber, $content = '')
    {
        ...
        if ($pageNumber < $counter - 1)
            $content.= "<li><a href='".$this->currentPageUrl.'/'.$this->next."'>» </a><li class=\"footable-page\">";
        else
            $content.= "<li><a class=\"disabled\">» </a></li>";
        $content.= "</ul>\n";
